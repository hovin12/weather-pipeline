...
MAIN_QUERY = """
    SELECT 
    run_ts AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Berlin' AS run_ts,
    city,
    temp,
    perceived_temp,
    temp_min,
    ...
    sunrise AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Berlin' AS sunrise,
    sunset AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Berlin' AS sunset
    FROM weather
